 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R=()=>P().__FIREBASE_DEFAULTS__,W=()=>{if(typeof process>"u"||typeof S>"u")return;const e=S.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},V=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&L(e[1]);return t&&JSON.parse(t)},C=()=>{try{return M()||R()||W()||V()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},Q=e=>{var t,r;return(r=(t=C())==null?void 0:t.emulatorHosts)==null?void 0:r[e]},X=()=>{var e;return(e=C())==null?void 0:e.config},Y=e=>{var t;return(t=C())==null?void 0:t[`_${e}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(e){try{return(e.startsWith("http://")||e.startsWith("https://")?new URL(e).hostname:e).endsWith(".cloudworkstations.dev")}catch{return!1}}async function te(e){return(await fetch(e,{credentials:"include"})).ok}const p={};function F(){const e={prod:[],emulator:[]};for(const t of Object.keys(p))p[t]?e.emulator.push(t):e.prod.push(t);return e}function U(e){let t=document.getElementById(e),r=!1;return t||(t=document.createElement("div"),t.setAttribute("id",e),r=!0),{created:r,element:t}}let B=!1;function re(e,t){if(typeof window>"u"||typeof document>"u"||!j(window.location.host)||p[e]===t||p[e]||B)return;p[e]=t;function r(s){return`__firebase__banner__${s}`}const n="__firebase__banner",i=F().prod.length>0;function a(){const s=document.getElementById(n);s&&s.remove()}function c(s){s.style.display="flex",s.style.background="#7faaf0",s.style.position="fixed",s.style.bottom="5px",s.style.left="5px",s.style.padding=".5em",s.style.borderRadius="5px",s.style.alignItems="center"}function l(s,u){s.setAttribute("width","24"),s.setAttribute("id",u),s.setAttribute("height","24"),s.setAttribute("viewBox","0 0 24 24"),s.setAttribute("fill","none"),s.style.marginLeft="-6px"}function f(){const s=document.createElement("span");return s.style.cursor="pointer",s.style.marginLeft="16px",s.style.fontSize="24px",s.innerHTML=" &times;",s.onclick=()=>{B=!0,a()},s}function y(s,u){s.setAttribute("id",u),s.innerText="Learn more",s.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",s.setAttribute("target","__blank"),s.style.paddingLeft="5px",s.style.textDecoration="underline"}function h(){const s=U(n),u=r("text"),d=document.getElementById(u)||document.createElement("span"),E=r("learnmore"),v=document.getElementById(E)||document.createElement("a"),A=r("preprendIcon"),b=document.getElementById(A)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(s.created){const g=s.element;c(g),y(v,E);const O=f();l(b,A),g.append(b,d,v,O),document.body.appendChild(g)}i?(d.innerText="Preview backend disconnected.",b.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H="FirebaseError";class _ extends Error{constructor(t,r,n){super(r),this.code=t,this.customData=n,this.name=H,Object.setPrototypeOf(this,_.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,$.prototype.create)}}class ${constructor(t,r,n){this.service=t,this.serviceName=r,this.errors=n}create(t,...r){const n=r[0]||{},o=`${this.service}/${t}`,i=this.errors[t],a=i?Z(i,n):"Error",c=`${this.serviceName}: ${a} (${o}).`;return new _(o,c,n)}}function Z(e,t){return e.replace(q,(r,n)=>{const o=t[n];return o!=null?String(o):`<${n}?>`})}const q=/\{\$([^}]+)}/g;function le(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}function z(e,t){if(e===t)return!0;const r=Object.keys(e),n=Object.keys(t);for(const o of r){if(!n.includes(o))return!1;const i=e[o],a=t[o];if(w(i)&&w(a)){if(!z(i,a))return!1}else if(i!==a)return!1}for(const o of n)if(!r.includes(o))return!1;return!0}function w(e){return e!==null&&typeof e=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ye(e){return e&&e._delegate?e._delegate:e}export{ee as D,$ as E,_ as F,Y as a,K as b,oe as c,z as d,ie as e,Q as f,X as g,se as h,ce as i,ye as j,pe as k,j as l,x as m,L as n,ae as o,te as p,fe as q,ne as r,le as s,he as t,re as u,ue as v,de as w};
